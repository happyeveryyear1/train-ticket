...
public class TravelController {
    ...
    public HttpEntity updateTrip(@RequestBody TravelInfo info, @RequestBody Trip trip3,@RequestBody Trip trip, @RequestBody Trip trip1,@RequestHeader HttpHeaders headers) {
        // Trip
    ...
    public HttpEntity deleteTrip(@PathVariable String tripId, @RequestBody Trip trip,@RequestBody Trip trip6, @RequestBody Trip trip1,@RequestBody Trip trip2,@RequestBody Trip trip3, @RequestBody Trip trip5, @RequestHeader HttpHeaders headers) {
        // string
    ...
    public HttpEntity queryInfo(@RequestBody TripInfo info, @RequestBody Trip trip,@PathVariable String tripId7, @PathVariable String tripId1, @PathVariable String tripId2,@PathVariable String tripId3,@PathVariable String tripId4, @PathVariable String tripId5, @PathVariable String tripId6,@RequestHeader HttpHeaders headers) {
    ...
    public HttpEntity queryInfoInparallel(@RequestBody TripInfo info, @RequestBody Trip trip, @RequestHeader HttpHeaders headers) {
        if (info.getStartPlace() == null || info.getStartPlace().length() == 0 ||
                info.getEndPlace() == null || info.getEndPlace().length() == 0 ||
                info.getDepartureTime() == null || trip.getEndTime() == null || trip.getRouteId() == null || trip.getTripId() == null) {
