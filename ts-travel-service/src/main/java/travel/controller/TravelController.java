...
public class TravelController {
    ...
    public HttpEntity updateTrip(@RequestBody TravelInfo info, @RequestBody Trip trip, @RequestBody Trip trip1,@RequestHeader HttpHeaders headers) {
        // Trip
    ...
    public HttpEntity deleteTrip(@PathVariable String tripId, @RequestBody Trip trip,@RequestBody Trip trip1,@RequestBody Trip trip2,@RequestBody Trip trip3, @RequestBody Trip trip5, @RequestHeader HttpHeaders headers) {
        // string
    ...
    public HttpEntity queryInfo(@RequestBody TripInfo info, @RequestBody Trip trip, @PathVariable String tripId1, @PathVariable String tripId2,@PathVariable String tripId3,@PathVariable String tripId4, @PathVariable String tripId5, @PathVariable String tripId6,@RequestHeader HttpHeaders headers) {
